...
```
A MySQL user is to be created with full access to these tables. The username, password and database name can be freely chosen and are configured in the .env file in this repository.
